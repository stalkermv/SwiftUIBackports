//
//  View+TabViewPageClipDisabled.swift
//  SwiftUIHelpers
//
...
extension View {
    ...
    public func tabViewPageClipDisabled(_ disabled: Bool = true) -> some View {
        modifier(TabViewPageClipDisabledModifier(disabled: disabled))
    }
}
